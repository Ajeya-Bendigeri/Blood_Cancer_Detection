...
l1 = tk.Label(my_w,text='Blood Cancer Detection',width=30,font=30, fg="orange")  
l1.grid(row=1,column=15)

b1 = tk.Button(my_w, text='Upload File',width=20,command = lambda:upload_file(),bg='orange')
b1.grid(row=2,column=1) 

b2 = tk.Button(my_w, text='Predict',width=20,command = lambda:predict_file())
...
def predict_file():    
    ...
    l2 = tk.Label(my_w,text=txt,width=30,font=my_font1)  
